...
class DjangoApprovalRepository(ApprovalRepository):
    def record_approval(self, claim_id, approver_id, status, comment):
        Approval.objects.create(claim_id=claim_id, approver_id=approver_id, status=status, comment=comment)
