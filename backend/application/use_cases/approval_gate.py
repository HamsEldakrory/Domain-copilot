...
class ApprovalGateUseCase:
    ...
    def decide(self, claim_id, job_id, approver_id, decision, outcome=None, rationale=None, comment=""):
        ...
        # approve or edit both proceed to finalize; "edit" just means the
        # outcome/rationale passed in reflect the adjuster's changes
        finalize_result = self._finalize_tool.run(
            claim_id=claim_id, approved_by=approver_id, outcome=outcome or "approved", rationale=rationale or comment,
        )
